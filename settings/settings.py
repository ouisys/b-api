"""
Django settings for buzik Project
...
with open("/var/www/webroot/ROOT/etc/cyclos/cyclos_constants.yml", 'r') as cyclos_stream:
    try:
        CYCLOS_CONSTANTS = yaml.load(cyclos_stream, Loader=yaml.FullLoader)
    except yaml.YAMLError as exc:
        assert False, exc

DOLIBARR_CONSTANTS = None
with open("/var/www/webroot/ROOT/etc/dolibarr/dolibarr_constants.yml", 'r') as dolibarr_stream:
    try:
        DOLIBARR_CONSTANTS = yaml.load(dolibarr_stream, Loader=yaml.FullLoader)
    except yaml.YAMLError as exc:
        assert False, exc
...
# APIs URLs -- MaJ
DOLIBARR_URL = 'http://gestion.jls-sto3.elastx.net/api/index.php'
CYCLOS_URL = 'http://banking.jls-sto3.elastx.net/buzuk/web-rpc'
...
APPS_ANONYMOUS_LOGIN = 'app_api'
APPS_ANONYMOUS_PASSWORD = 'b1tpg8wf'
